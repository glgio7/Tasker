	...
	return (
		<>
			<TextSection>
				...
				<p>
					Interface simples e intuitiva, crie e edite anotações rapidamente, sem
					distrações.
				</p>
				<p>
					Integração direta com o Climaki, confira a previsão do tempo antes de
					marcar seus compromissos sem sair da plataforma.
				</p>
				<p>
